...
from models import ProductImage, Products, UserProducts, User, Make_request, Testimonial, app, db, LoginManager, login_required, login_user, logout_user, current_user, Bet_49ja, Financial_data, Transaction_Table, current_user
...
import soccer_prediction, json, re
...
def add_items():
    if request.method ==  "POST":
        ...
        product = Products(title=title, description=description, youtube_link=youtube_link, price=price, old_price=old_price, store_id=1)
