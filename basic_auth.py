...
from models import UserProducts, Predictions, db, app, Confirm_mail, Transaction_Table, User, Reset_password, current_user, Bet_49ja, Make_request, Store, Predictions, Products, ProductImage, Referral
...
admin = Admin(app)
admin.add_view(ModelView(Predictions, db.session))
...
admin.add_view(ModelView(UserProducts, db.session))
# admin.add_view(ModelView(Make_request, db.session))
